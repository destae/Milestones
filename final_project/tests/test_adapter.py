...
import os
import unittest
from final_project.src.adapter import Adapter
from final_project.src.schema import Schema

class TestAdapter(unittest.TestCase):

    def setUp(self):
        self.test_file_name = f"{os.getcwd()}/final_project/tests/test_data.sor"
    ...
    def test_determine_number_of_rows2(self):
        row_file = f"{os.getcwd()}/final_project/tests/less_rows.sor"
