...
from final_project.src.dataframe import Dataframe
from final_project.src.schema import Schema
from final_project.src.kv_store import Key, KeyValueStore
...
class TestDataframe(unittest.TestCase):
    ...
    def test_dataframe_from_array(self):
        ...
        test_schema = Schema(sch=["F"],ncols=1,nrows=500)
    ...
    def test_dataframe_from_scalar(self):
        ...
        self.assertEqual(Schema(sch=["F"],ncols=1,nrows=1), d.schema)
    ...
    def test_dataframe_to_json(self):
        ...
        self.maxDiff = None
        self.assertEqual(serialize_dataframe(self.data_frame), json.dumps(test_dict))
    ...
    def test_json_to_dataframe(self):
        ...
        self.assertEqual(self.data_frame.data, deserialize_dataframe(json_df).data)
    ...
    def test_json_to_dataframe2(self):
        ...
        test_dataframe = deserialize_dataframe(json_df)
        self.assertEqual(d.data, test_dataframe.data) 
