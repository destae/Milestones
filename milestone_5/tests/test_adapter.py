...
import os
import unittest
from milestone_5.src.adapter import Adapter
from milestone_5.src.adapter import Schema

class TestAdapter(unittest.TestCase):

    def setUp(self):
        self.test_file_name = f"{os.getcwd()}/milestone_5/tests/test_data.sor"
    ...
    def test_determine_number_of_rows2(self):
        row_file = f"{os.getcwd()}/milestone_5/tests/less_rows.sor"
