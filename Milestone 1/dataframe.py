...
class Dataframe:
        ...
        while line:
            ...
            for i in range(len(line)):
                if line[i] == '<':
                    ...
                    self.data[current_row][current_column] = extract_data(line, start_index, end_index, current_column)
            line = self.data_file.readline()
    ...
    def extract_data(self, data, start_index, end_index, current_column):
        ...
        data_type = determine_type(temp_data)

        if data_type == schema[current_column]:
            return temp_data
        else:
            return ""
